...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Seller Transparency Hub — Profit, Fees & Account Health for Sellers" },
      ...
      { property: "og:title", content: "Seller Transparency Hub — Profit, Fees & Account Health for Sellers" },
      ...
      { name: "twitter:title", content: "Seller Transparency Hub — Profit, Fees & Account Health for Sellers" },
