...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free tools for Amazon, Walmart, Shopify, and Etsy sellers: calculate marketplace fees, project profit, monitor account health, and prevent suspensions." },
      { name: "author", content: "Seller Transparency Hub" },
      { property: "og:title", content: "Seller Transparency Hub | Fees & Profit Tools" },
      { property: "og:description", content: "Free tools for Amazon, Walmart, Shopify, and Etsy sellers: calculate marketplace fees, project profit, monitor account health, and prevent suspensions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Seller Transparency Hub | Fees & Profit Tools" },
      { name: "twitter:description", content: "Free tools for Amazon, Walmart, Shopify, and Etsy sellers: calculate marketplace fees, project profit, monitor account health, and prevent suspensions." },
